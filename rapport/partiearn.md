...
Pour l'applications des algorithmes à un nouveau type de donnée, la seule adaptation que nous avons du faire à été de programmer un parseur, et de mettre en place la génération de la matrice d'adjacence.
